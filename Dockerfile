...
RUN apt install hydra -y && apt install net-tools -y && apt install nmap -y && apt install aircrack-ng -y && apt install crackmapexec -y && apt install wfuzz -y && apt install gobuster -y && apt install john -y && apt install crunch -y && apt install netcat-traditional -y && apt install hping3 -y
